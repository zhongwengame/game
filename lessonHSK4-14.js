...
const lessonData = {
    ...
    "module_9_vocab_practice": [
        ...
        { "question": "工厂流出来的脏水____了河流。", "options": ["污染", "扔", "鼓励", "丢"], "answer": "污染" },
        { "question": "这个____有点儿脏，需要打扫一下。", "options": ["卫生间", "目的", "塑料袋", "垃圾"], "answer": "卫生间" },
        { "question": "夏天的____很高，要注意身体。", "options": ["温度", "速度", "数量", "目的"], "answer": "温度" },
        ...
        { "question": "他每天____地铁上下班。", "options": ["乘坐", "扔", "丢", "停"], "answer": "乘坐" },
        { "question": "请把垃圾____进垃圾桶。", "options": ["丢", "重", "乘坐", "停"], "answer": "丢" },
        { "question": "这个公园的景色非常____。", "options": ["美丽", "得意", "抱歉", "脏"], "answer": "美丽" },
        { "question": "我们只有一个____，所以要保护好____。", "options": ["地球, 环境", "目的, 速度", "数量, 温度", "生活, 习惯"], "answer": "地球, 环境" }
    ],
